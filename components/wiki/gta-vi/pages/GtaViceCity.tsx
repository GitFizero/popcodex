  ...
  return (
    <div className="min-h-screen pt-16 pb-10">
      ...
      <section className="relative py-14 px-4 text-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-bg-void via-[#0a0520] to-bg-void" />
      ...
      <RevealOnScroll>
        <section className="py-12 px-4">
          <div className="max-w-3xl mx-auto">
            <div className="relative bg-bg-card rounded-xl border border-dashed border-neon-cyan/20 overflow-hidden p-10 sm:p-16 text-center">
      ...
      <RevealOnScroll>
        <section className="py-6 px-4">
          <div className="max-w-2xl mx-auto bg-bg-card rounded-xl p-5 border border-neon-cyan/10">
              ...
              <div className="bg-bg-raised rounded-lg p-3">
                ...
                <div className="flex flex-wrap gap-1.5 mt-1.5">
                  {active.characters.map(c => (
                    <span key={c} className="font-rajdhani text-[0.6rem] px-2 py-0.5 rounded bg-bg-card text-text-secondary">{c}</span>
                  ))}
                </div>
              </div>
              <div className="bg-bg-raised rounded-lg p-3">
                ...
                <div className="flex flex-wrap gap-1.5 mt-1.5">
                  {active.features.map(f => (
                    <span key={f} className="font-rajdhani text-[0.6rem] px-2 py-0.5 rounded bg-bg-card text-text-secondary">{f}</span>
                  ))}
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {locations.map(loc => (
              <button
                ...
                className={`text-left bg-bg-card rounded-lg p-4 border transition-all hover:-translate-y-1 ${
