...
const NavBar = memo(() => {
  ...
  const { setSearchOpen, noirMode, toggleNoirMode } = useApp();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              aria-label={noirMode ? 'Dark mode' : 'Noir mode'}
              title={noirMode ? t('footer.dark_mode') : t('footer.noir')}
            >
              {noirMode ? <Moon size={15} /> : <Sun size={15} />}
            </button>
