...
export interface BlogArticle {
  ...
  publishedAt: string;
  readingTime: number;
  tags: { fr: string; en: string; es?: string; it?: string }[];
...
const kliffPortrait = '/images/crimson-desert/kliff-portrait-front.jpg';
const bossStag = '/images/crimson-desert/boss-staglord.jpg';
