...
export interface Region {
  ...
  locations: Location[];
  enemies: string[];
  quests: { fr: string[]; en: string[]; es?: string[]; it?: string[]; ko?: string[]; de?: string[] };
...
export const regions: Region[] = [
  {
    id: 'hernand',
    name: 'Hernand',
    subtitle: { fr: 'La Cité Marchande', en: 'The Trade City', ko: '교역 도시', de: 'Die Handelsstadt' },
    ...
    description: {
      ...
      de: "Eine belebte Handelsstadt am Kreuzweg von Pywel, wo Händler, Söldner und Geheimnisse zusammentreffen.",
    },
    overview: {
      ...
      de: "Hernand ist das schlagende Herz des Handels in Pywel. Eingebettet zwischen schützenden Gebirgszügen und fruchtbaren Ebenen wuchs die Stadt entlang der Handelsrouten, die die Regionen des Kontinents verbinden.",
    },
    locations: [
      ...
      { name: { fr: 'Stockage Privé de Hernand', en: 'Hernand Private Storage' }, description: { fr: 'Coffre de stockage privé ajouté avec le patch 1.00.03. Disponible dans les logements de Hernand.', en: 'Private storage chest added in patch 1.00.03. Available at Hernand lodgings.' }, type: 'Service' },
      { name: { fr: 'Camp de Howling Hill', en: 'Howling Hill Camp' }, description: { fr: 'Campement de base des Greymanes à Hernand. Stockage privé et services de campement ajoutés en patch 1.00.03.', en: 'Greymane base camp in Hernand. Private storage and camp services added in patch 1.00.03.' }, type: 'Camp' },
      { name: { fr: 'Manoir de Lioncrest', en: 'Lioncrest Manor' }, description: { fr: 'Proche du château de Hernand. Contient la Brass Wardens Plate, le Bouclier Rhonid et un lingot d\'or (500 pièces d\'argent).', en: 'Near Hernand Castle. Contains the Brass Wardens Plate, Rhonid Large Shield, and a gold bar (500 silver).' }, type: 'Secret' },
    ],
    ...
    quests: { fr: ['Commissions de Hernand (x3 emplacements inventaire)', 'Le lingot d\'or du Manoir', 'Primes : chasse aux criminels', 'Le concours d\'archerie', 'Quête de la Guilde Feuille d\'Or'], en: ['Hernand Commissions (x3 inventory slots)', 'The Manor Gold Bar', 'Bounties: Criminal Hunting', 'The Archery Contest', 'Goldleaf Guild Quest'], de: ['Hernand-Aufträge (x3 Inventarplätze)', 'Der Goldbarren des Herrenhauses', 'Kopfgelder: Verbrecherjagd', 'Der Bogenschießwettbewerb', 'Goldblatt-Gildenquest'] },
  ...
  },
  {
    id: 'pailune',
    name: 'Pailune',
    subtitle: { fr: 'Patrie des Greymanes', en: 'Homeland of the Greymanes', ko: '그레이메인의 고향', de: 'Heimat der Greymanes' },
    ...
    description: {
      ...
      de: "Einst blühende Heimat der Greymane-Söldner, nun eine Ruine — ein Denkmal der Nacht der Schwarzen Bären.",
    },
    overview: {
      ...
      de: "Pailune war einst die friedlichste Region Pywels — sanfte grüne Hügel, übersät mit Greymane-Siedlungen. Die Nacht der Schwarzen Bären hat alles verändert.",
    },
    locations: [
  ...
  },
  {
    id: 'demeniss',
    name: 'Déméniss',
    subtitle: { fr: 'Territoire Contesté', en: 'Contested Territory', ko: '분쟁 지역', de: 'Umkämpftes Gebiet' },
    ...
    description: {
      ...
      de: "Ein vom Krieg zerrissenes Grenzland, in dem jede Fraktion um die Vorherrschaft kämpft.",
    },
    overview: {
      ...
      de: "Déméniss ist das Niemandsland von Pywel. An der Schnittstelle mehrerer Gebietsgrenzen gelegen, wird es seit Jahrhunderten umkämpft.",
    },
    locations: [
    ...
    quests: { fr: ['Conflit Thorel vs Byron', 'L\'arène des chevaliers', 'La quête de Cassius Morten (chevalier cramoisi)', 'Fortain : le géant maudit', 'Missions de faction : réputation'], en: ['Thorel vs Byron Conflict', 'The Knight\'s Arena', 'Cassius Morten Quest (crimson knight)', 'Fortain: The Cursed Giant', 'Faction Missions: Reputation'], de: ['Thorel-gegen-Byron-Konflikt', 'Die Arena der Ritter', 'Cassius-Morten-Quest (Scharlachroter Ritter)', 'Fortain: Der verfluchte Riese', 'Fraktionsmissionen: Reputation'] },
  ...
  },
  {
    id: 'delesyie',
    name: 'Délésyie',
    subtitle: { fr: 'La Région Mystérieuse', en: 'The Mysterious Region', ko: '신비로운 지역', de: 'Die Geheimnisvolle Region' },
    ...
    description: {
      ...
      de: "In ewigen Nebel gehüllt, verbirgt Délésyie uralte Ruinen und Artefakte von immenser Macht.",
    },
    overview: {
      ...
      de: "Délésyie existiert am Rand der bekannten Welt, wo der Schleier zwischen Realität und Abgrund dünner wird. Ewiger silberner Nebel verhüllt seine Berggipfel.",
    },
    locations: [
    ...
    quests: { fr: ['L\'éveil de Golden Star (dragon mécanique)', 'Recherches de l\'institut de Dewhaven', 'Alliance avec les Orques Flamme de Fer', 'Le secret de Tenebrum', 'Exploration des îles célestes'], en: ['Golden Star Awakening (mechanical dragon)', 'Dewhaven Institute Research', 'Ironflame Orc Alliance', 'The Secret of Tenebrum', 'Sky Islands Exploration'], de: ['Erwachen des Golden Star (mechanischer Drache)', 'Forschung am Dewhaven-Institut', 'Allianz mit den Eisenflammen-Orks', 'Das Geheimnis von Tenebrum', 'Erkundung der Himmelsinseln'] },
  ...
  },
  {
    id: 'desert-pourpre',
    name: 'Désert Pourpre',
    subtitle: { fr: 'Le Désert Écarlate', en: 'The Crimson Desert', ko: '진홍 사막', de: 'Die Purpurwüste' },
    ...
    description: {
      ...
      de: "Die weite Wüste mit scharlachrotem Sand, die dem Spiel seinen Namen gibt.",
    },
    overview: {
      ...
      de: "Die Purpurwüste — die scharlachrote Wüste, die dem Spiel seinen Namen gibt. Diese weite Fläche rostrotem Sandes ist gleichermaßen schön und tödlich.",
    },
    locations: [
