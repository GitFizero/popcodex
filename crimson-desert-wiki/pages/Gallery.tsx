...
const categoryLabels: Record<Category, Record<Lang, string>> = {
  ...
  LANDSCAPES: { fr: 'Paysages', en: 'Landscapes', es: 'Paisajes', it: 'Paesaggi', ko: '풍경' },
  CHARACTERS: { fr: 'Personnages', en: 'Characters', es: 'Personajes', it: 'Personaggi', ko: '캐릭터' },
  COMBAT: { fr: 'Combat', en: 'Combat', es: 'Combate', it: 'Combattimento', ko: '전투' },
  BOSSES: { fr: 'Boss', en: 'Bosses', es: 'Jefes', it: 'Boss', ko: '보스' },
};

const galleryTitle: Record<Lang, string> = { fr: 'Galerie', en: 'Gallery', es: 'Galería', it: 'Galleria', ko: '갤러리' };
const galleryH1: Record<Lang, string> = { fr: 'Galerie — Crimson Desert', en: 'Gallery — Crimson Desert', es: 'Galería — Crimson Desert', it: 'Galleria — Crimson Desert', ko: '갤러리 — Crimson Desert' };
...
const fanUse: Record<Lang, string> = { fr: 'Utilisation fan non-commerciale', en: 'Non-commercial fan use', es: 'Uso fan no comercial', it: 'Uso fan non commerciale', ko: '비상업적 팬 사용' };
const closeLabel: Record<Lang, string> = { fr: 'Fermer', en: 'Close', es: 'Cerrar', it: 'Chiudi', ko: '닫기' };
