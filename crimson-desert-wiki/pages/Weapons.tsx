...
const weapons: WeaponInfo[] = [
  {
    id: 'sword-shield',
    name: { fr: 'Épée et bouclier', en: 'Sword & Shield', es: 'Espada y escudo', it: 'Spada e scudo', ko: '검과 방패' },
    category: { fr: 'Mêlée — Équilibré', en: 'Melee — Balanced', es: 'Cuerpo a cuerpo — Equilibrado', it: 'Mischia — Equilibrato', ko: '근접 — 균형' },
    description: {
  ...
  {
    id: 'spear',
    name: { fr: 'Lance', en: 'Spear', es: 'Lanza', it: 'Lancia', ko: '창' },
    category: { fr: 'Mêlée — Portée', en: 'Melee — Range', es: 'Cuerpo a cuerpo — Alcance', it: 'Mischia — Portata', ko: '근접 — 사거리' },
    description: {
  ...
  {
    id: 'greatsword',
    name: { fr: 'Grande épée', en: 'Greatsword', es: 'Espadón', it: 'Spadone', ko: '대검' },
    category: { fr: 'Mêlée — Puissance', en: 'Melee — Power', es: 'Cuerpo a cuerpo — Potencia', it: 'Mischia — Potenza', ko: '근접 — 파워' },
    description: {
  ...
  {
    id: 'axe',
    name: { fr: 'Hache', en: 'Axe', es: 'Hacha', it: 'Ascia', ko: '도끼' },
    category: { fr: 'Mêlée — Agression', en: 'Melee — Aggression', es: 'Cuerpo a cuerpo — Agresión', it: 'Mischia — Aggressione', ko: '근접 — 공격적' },
    description: {
  ...
  {
    id: 'dual-blades',
    name: { fr: 'Doubles lames', en: 'Dual Blades', es: 'Dobles espadas', it: 'Doppie lame', ko: '쌍검' },
    category: { fr: 'Mêlée — Vitesse', en: 'Melee — Speed', es: 'Cuerpo a cuerpo — Velocidad', it: 'Mischia — Velocità', ko: '근접 — 속도' },
    description: {
  ...
  {
    id: 'bow',
    name: { fr: 'Arc', en: 'Bow', es: 'Arco', it: 'Arco', ko: '활' },
    category: { fr: 'Distance — Précision', en: 'Ranged — Precision', es: 'Distancia — Precisión', it: 'Distanza — Precisione', ko: '원거리 — 정밀' },
    description: {
